...
// Third TMC2209-driven stepper. Same behavior as Motor2 — a bounded
...
static_assert(Motor3::kStepIntervalMinUs < Motor3::kStepIntervalMaxUs,
              "min step interval must be smaller than max (fast < slow)");
static_assert(Motor3::kMaxPositionSteps > 0,
              "max position must be positive");
static_assert(Motor3::kStepIntervalMinUs % Motor3::kTimerPeriodUs == 0,
